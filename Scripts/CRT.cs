...
public sealed class CRT : PostProcessEffectSettings
{
    ...
    [Range(0f, 1f)]
    public FloatParameter RGBBlend = new FloatParameter { value = 0.5f };
    [Range(0f, 1f)]
    public FloatParameter BottomCollapse = new FloatParameter { value = 0.02f };
    [Range(0f, 1f)]
    public FloatParameter NoiseAmount = new FloatParameter { value = 0.3f };
